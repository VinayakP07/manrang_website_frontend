...
const GownOnePiece = () => {
  ...
  const fetchUserDetails = async () => {
    ...
    const fetchProductData = async () => {
      try {
        ...
        const kurtiesProducts = allProducts.filter(product => product.section === 'Gown & One Piece');
  ...
  return (
    <>
      ...
      <h2 className={styles.heading}>Gowns and One Pieces</h2>
