...
const DupattaStole = () => {
  ...
  const fetchProductData = async () => {
    try {
      ...
      const kurtiesProducts = allProducts.filter(product => product.section === 'Duppatta & Stole');
  ...
  return (
    <>
      ...
      <h2 className={styles.heading}>Dupattas and Stoles</h2>
